        ...
        <div style="float:left;margin-bottom:60px;">
         ...
         <!--  <div style="clear:both;float:left;">
            <form class="form-inline" role="form">
      			   <button type="button" class="btn-p btn btn-primary pull-left">导出PDF</button>
             </form>
        </div>-->
          ...
          <table class="table" >
           ...
           <template v-if="list.data.length !=0">
            ...
            <tr v-for="v in list.data">
                ...
                <td>
                      <router-link tag="button" :to="{name:'payrecorddetail', params:{id:v.id}}"  type="button" style="font-size:13px;height:35px;" class="btn-p btn btn-primary btn-sm">详情</router-link>
                    </td>
            </tr>
